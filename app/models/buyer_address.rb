class BuyerAddress
  ...
  def save
    ...
    Address.create(post_code: post_code, region_id: region_id, manicipalities: manicipalities, address: address,
                   building: building, phone_number: phone_number, buyer_id: @buyer.id)
  end
end
